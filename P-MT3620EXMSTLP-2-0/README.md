# Azure Sphere Low Power External MCU To Cloud Reference V2.0 Design and Production Files

This project provides a hardware reference design that demonstrates how to integrate an MT3620 module and an external MCU onto a single printed circuit board (PCB) with a low-power design.  Specifically, it incorporates an ultra-low-power [STM32L031](https://www.st.com/en/microcontrollers-microprocessors/stm32l031k6.html) microcontroller and an Azure Sphere module from [Avnet](https://www.avnet.com/shop/us/products/avnet-engineering-services/aes-ms-mt3620-m-g-2-3074457345643590217/) in a design implemented on a 4 layer printed circuit board (PCB) with a total thickness of approximately 1.6mm. The architecture showcases the following:
...
The board is designed to interface with the Azure Sphere [FTDI Interface board](https://github.com/Azure/azure-sphere-hardware-designs/tree/main/P-FTINT-2-0). This provides a way to connect the board to a host computer via a USB port for programming/debugging/recovering as with an MT3620 RDB.
...
[ ![hardware setup](./media/P-MT3620EXMSTLP-2-0-hardware-setup.jpg) ](./media//P-MT3620EXMSTLP-2-0-hardware-setup-5X.jpg#lightbox)
...
- Altium P-MT3620EXMSTLP-2-0  folder contains the Altium Designer schematics, PCB layout, and supporting project files.
  ...
  - P-MT3620EXMSTLP-2-0.OutJob  describes the PCB output generation structure.
  - P-MT3620EXMSTLP-2-0.PcbDoc  describes the PCB design.
  - P-MT3620EXMSTLP-2-0.PrjPcb  is the Hardware design project file for Altium.
...
- Production P-MT3620EXMSTLP-2-0  folder contains the gerber, drill, and pick and place data files, along with a detailed variant report file.
...
- P-MT3620EXMSTLP-2-0_Structured_BoM (Production).xlsx                is an Excel spreadsheet that contains the bill of materials.
- P-MT3620EXMSTLP-2-0-Production.PDF           is a collection of the schematic documents in PDF format along with the board stack up.
...
The Avnet module V2 is used in this design. This design is also compatible with the V1 of the Avnet module - see further information on Page 3 of Schematic (alternatively refer to [V1.0](https://github.com/Azure/azure-sphere-hardware-designs/tree/main/P-MT3620EXMSTLP-1-0) of this design).
...
| Version | Notes                                                        |
| :-----: | :----------------------------------------------------------- |
|  V2.0   | 1. Updated the design to use the Avnet Azure Sphere module V2<br />2. Incorporated the recommendation from [Programming and Debugging Interface]([MCU Programming and Debugging Interface Guide - Azure Sphere ) guidelines and connected the MT3620 SYSRST_N and WAKEUP signals using a diode array. |
|  V1.0   | 1. Initial version of the design.                            |
